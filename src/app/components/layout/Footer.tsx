  ...
  return (
    <div className='text-white'>
      <div className='bg-black  py-2 px-4 md:py-4 md:px-10'>
        ...
        {/* image */}
        <div>
          <Image src="/logo/logo.png" alt="" height={200} width={200}
          className='mb-6' />
        </div>
        {/* remaining */}
        <div className='p-4 md:p-0'>
        <div className='md:flex justify-between space-y-12 md:space-y-0 font-extralight'>
          <div className='md:p-2 space-y-4'>
            ...
            <div>
              ...
              <p className='font-light text-lg'>crayomi@gmail.com</p>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            {/* input field */}
          <div>
            <h2 className='mb-2 text-medium font-normal'>&quot;Subscribe to get new product updates!&quot;</h2>
            <div className='flex p-1 rounded-full bg-white justify-between items-center '>
              <input 
              type="text"
              placeholder="  example@email.com"
              className='outline-none rounded-full h-10 border-none w-48  text-black' />
